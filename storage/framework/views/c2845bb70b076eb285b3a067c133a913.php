    ...
    <div class="settings-card">
        <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST" class="settings-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?php echo e(Auth::user()->name); ?>" required minlength="3" maxlength="50" placeholder="Masukkan username baru">
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\eco21-main\resources\views/admin/settings.blade.php ENDPATH**/ ?>