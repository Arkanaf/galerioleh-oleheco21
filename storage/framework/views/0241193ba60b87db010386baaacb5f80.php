...
<div class="admin-header">
    ...
    <a href="<?php echo e(route('admin.content.create')); ?>" class="btn btn-primary">+ Tambah Konten</a>
</div>
...
<?php if(count($contents) === 0): ?>
    <div class="alert alert-info">Belum ada konten. <a href="<?php echo e(route('admin.content.create')); ?>">Buat konten baru</a></div>
<?php else: ?>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $contents[$section]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo e(route('admin.content.edit', $content)); ?>" class="btn btn-sm btn-warning">Edit</a>
                                        
                                        <form action="<?php echo e(route('admin.content.destroy', $content)); ?>" method="POST" style="display: inline;">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\eco21-main\resources\views/admin/content/index.blade.php ENDPATH**/ ?>